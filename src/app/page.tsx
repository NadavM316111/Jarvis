...
<button
  ...
  className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl border text-xs font-medium transition-all mb-2 border-black/10 hover:border-black/20`}
  style={{ color: 'var(--jarvis-text-sub)', background: 'var(--jarvis-card)' }}
>
